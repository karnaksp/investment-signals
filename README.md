...
Документация: [архитектура](docs/architecture.md), [детекторы](docs/detectors.md), [Signal Cockpit](docs/admin_cockpit.md), [Dagster](docs/orchestration.md), [SQL по сигналам](docs/signal_analytics.md), [release notes](docs/release_notes.md), [решение проблем](docs/troubleshooting.md) (Telegram, синтетический тест, ClickHouse).
